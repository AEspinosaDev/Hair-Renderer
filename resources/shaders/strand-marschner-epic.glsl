...
vec3 multipleScattering(vec3 n){ //Fake normal
...
void main() {
  ...
  vec3 color = computeLighting(u_hair.roughness, u_hair.shift, u_scene.lightColor * u_scene.lightIntensity, u_hair.r, u_hair.tt, u_hair.trt);
